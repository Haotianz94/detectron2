...
def setup(args):
    ...
    """
    TRAIN_NAME = 'usopen_nadal_v2'
    TEST_NAME = 'usopen_nadal_test'

    register_coco_instances("usopen_nadal_train",
                        {}, 
                        f"./data/{TRAIN_NAME}/annotations_train.json",
                        f"./data/{TRAIN_NAME}/images")

    register_coco_instances("usopen_nadal_val",
                        {}, 
                        f"./data/{TRAIN_NAME}/annotations_val.json",
                        f"./data/{TRAIN_NAME}/images")
    ...
    cfg.OUTPUT_DIR = f'./output/{TRAIN_NAME}'
